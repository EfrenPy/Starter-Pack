...
import { contractsCareerTranslations } from '../modules/translations/contracts-career.js';
...
async function init() {
  try {
    ...
    initNavbar();
    initTheme();
    initI18n(navbarTranslations, footerTranslations, contractsCareerTranslations);
    initScrollTop();
    initReadingProgress();
    initReadingTime();
