...
import { languageTrainingTranslations } from '../modules/translations/language-training.js';
...
async function init() {
  try {
    ...
    initNavbar();
    initTheme();
    initI18n(navbarTranslations, footerTranslations, languageTrainingTranslations);
    initScrollTop();
    initReadingProgress();
    initReadingTime();
