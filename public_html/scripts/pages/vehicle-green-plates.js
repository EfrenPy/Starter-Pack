...
import { vehicleGreenPlatesTranslations } from '../modules/translations/vehicle-green-plates.js';
...
async function init() {
  try {
    ...
    initNavbar();
    initTheme();
    initI18n(navbarTranslations, footerTranslations, vehicleGreenPlatesTranslations);
    initScrollTop();
    initReadingProgress();
    initReadingTime();
