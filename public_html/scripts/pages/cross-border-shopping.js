...
import { crossBorderShoppingTranslations } from '../modules/translations/cross-border-shopping.js';
...
async function init() {
  try {
    ...
    initNavbar();
    initTheme();
    initI18n(navbarTranslations, footerTranslations, crossBorderShoppingTranslations);
    initScrollTop();
    initReadingProgress();
    initReadingTime();
