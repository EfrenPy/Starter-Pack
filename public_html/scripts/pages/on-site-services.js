...
import { onSiteServicesTranslations } from '../modules/translations/on-site-services.js';
...
async function init() {
  try {
    ...
    initNavbar();
    initTheme();
    initI18n(navbarTranslations, footerTranslations, onSiteServicesTranslations);
    initScrollTop();
    initReadingProgress();
    initReadingTime();
