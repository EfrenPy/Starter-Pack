...
import { healthInsuranceTranslations } from '../modules/translations/health-insurance.js';
...
async function init() {
  try {
    ...
    initNavbar();
    initTheme();
    initI18n(navbarTranslations, footerTranslations, healthInsuranceTranslations);
    initScrollTop();
    initReadingProgress();
