...
import { permitsRegistrationTranslations } from '../modules/translations/permits-registration.js';
...
async function init() {
  try {
    ...
    initNavbar();
    initTheme();
    initI18n(navbarTranslations, footerTranslations, permitsRegistrationTranslations);
    initScrollTop();
    initReadingProgress();
    initReadingTime();
