...
import { childcareSchoolsTranslations } from '../modules/translations/childcare-schools.js';
...
async function init() {
  try {
    ...
    initNavbar();
    initTheme();
    initI18n(navbarTranslations, footerTranslations, childcareSchoolsTranslations);
    initScrollTop();
    initReadingProgress();
    initReadingTime();
