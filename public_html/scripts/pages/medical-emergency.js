...
import { medicalEmergencyTranslations } from '../modules/translations/medical-emergency.js';
...
async function init() {
  try {
    ...
    initNavbar();
    initTheme();
    initI18n(navbarTranslations, footerTranslations, medicalEmergencyTranslations);
    initScrollTop();
    initReadingProgress();
    initReadingTime();
