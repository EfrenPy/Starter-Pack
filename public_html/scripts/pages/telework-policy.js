...
import { teleworkPolicyTranslations } from '../modules/translations/telework-policy.js';
...
async function init() {
  try {
    ...
    initNavbar();
    initTheme();
    initI18n(navbarTranslations, footerTranslations, teleworkPolicyTranslations);
    initScrollTop();
    initReadingProgress();
    initReadingTime();
