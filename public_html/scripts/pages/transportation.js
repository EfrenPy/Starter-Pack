...
import { transportationTranslations } from '../modules/translations/transportation.js';
...
async function init() {
  try {
    ...
    initNavbar();
    initTheme();
    initI18n(navbarTranslations, footerTranslations, transportationTranslations);
    initScrollTop();
    initReadingProgress();
    initReadingTime();
