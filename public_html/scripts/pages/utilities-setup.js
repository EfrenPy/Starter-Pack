...
import { utilitiesSetupTranslations } from '../modules/translations/utilities-setup.js';
...
async function init() {
  try {
    ...
    initNavbar();
    initTheme();
    initI18n(navbarTranslations, footerTranslations, utilitiesSetupTranslations);
    initScrollTop();
    initReadingProgress();
    initReadingTime();
