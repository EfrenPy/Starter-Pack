...
import { safetyTrainingTranslations } from '../modules/translations/safety-training.js';
...
async function init() {
  try {
    ...
    initNavbar();
    initTheme();
    initI18n(navbarTranslations, footerTranslations, safetyTrainingTranslations);
    initScrollTop();
    initReadingProgress();
    initReadingTime();
