---
title: "Guía del Trabajador Transfronterizo (Frontalier) - CERN Starter Pack"
...
En el lado francés, los miembros del personal del CERN que residen en Francia reciben un **titre de sejour especial** (de tipo AT, FI o CD) emitido por el **Ministerio de Europa y de Asuntos Exteriores francés (MEAE)** y tramitado a través del CERN — **no** el permiso ordinario que se obtiene en la prefectura local. La solicitud requiere prueba de empleo en el CERN, prueba de residencia en Francia y documentos de identidad habituales; el plazo de tramitación habitual es de unas 6-8 semanas, así que solicítalo lo antes posible tras encontrar tu alojamiento francés. (Los familiares que empiecen a trabajar fuera del CERN pueden necesitar aún un permiso estándar emitido por la prefectura.)
...
- <a href="https://www.ge.ch/frontaliers" target="_blank" rel="noopener noreferrer">Canton de Geneve — Información para Frontaliers</a>
- <a href="https://www.service-public.fr/" target="_blank" rel="noopener noreferrer">Service-Public.fr — Portal Administrativo Francés</a>
