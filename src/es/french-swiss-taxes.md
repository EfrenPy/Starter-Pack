---
title: "Impuestos en Francia y Suiza - CERN Starter Pack"
description: "Obligaciones fiscales para empleados del CERN que viven en Francia o Suiza: declaraciones, ingresos externos, convenios de doble imposicion y consejos practicos."
og:
  title: "Impuestos en Francia y Suiza - CERN Starter Pack"
  description: "Obligaciones fiscales para empleados del CERN que viven en Francia o Suiza: declaraciones, ingresos externos, convenios de doble imposicion y consejos practicos."
breadcrumbs:
  ...
  - { label: "Impuestos en Francia y Suiza" }
---

<h1>Obligaciones Fiscales en Francia y Suiza para Empleados del CERN</h1>

      <div class="alert">
        <strong>⚠️ Importante</strong><br>
        <p>El salario del CERN esta exento del impuesto sobre la renta nacional, pero es posible que aun asi debas presentar una declaracion. Consulta siempre a un profesional fiscal para tu situacion particular.</p>
      </div>
      ...
      <p>Cualquier ingreso externo -- de alquileres, inversiones, dividendos o trabajo freelance -- debe declararse y se grava a los <strong>tipos impositivos franceses vigentes</strong>. Ten en cuenta que puede aplicarse la regla del <strong>taux effectif</strong>: tu salario exento del CERN puede utilizarse para calcular el tipo impositivo efectivo sobre tus otros ingresos, lo que podria aumentar el tipo marginal.</p>
      <p>La declaracion se presenta en linea en <strong>impots.gouv.fr</strong>, normalmente antes del plazo de mayo o junio segun tu departamento. Si eres nuevo residente, primero debes registrarte en el <strong>Service des Impots des Particuliers (SIP)</strong> de tu zona para obtener un numero fiscal antes de poder presentar la declaracion en linea.</p>

      <h2>Obligaciones Fiscales en Suiza (Residentes en Ginebra)</h2>
      <p>Si vives en el Canton de Ginebra u otra parte de Suiza, debes presentar una <strong>declaracion de impuestos cantonal y federal</strong> cada ano. Tu salario del CERN se declara en la declaracion pero se marca como exento. Cualquier ingreso externo -- alquileres, inversiones, trabajo por cuenta propia -- esta sujeto tanto al <strong>impuesto cantonal como al federal</strong>.</p>
      ...
      <ul>
        <li><a href="https://www.impots.gouv.fr/" target="_blank" rel="noopener noreferrer">Impots.gouv.fr -- Administracion Fiscal Francesa</a></li>
        <li><a href="https://www.ge.ch/impots" target="_blank" rel="noopener noreferrer">Canton de Ginebra -- Oficina de Impuestos</a></li>
        <li><a href="https://www.estv.admin.ch/" target="_blank" rel="noopener noreferrer">Administracion Federal de Impuestos de Suiza</a></li>
