---
title: "Guia de Salida - CERN Starter Pack"
description: "Guia completa para dejar el CERN: periodos de preaviso, procedimiento de clearance, opciones de pension, seguro medico, baja administrativa y logistica de mudanza."
og:
  title: "Guia de Salida - CERN Starter Pack"
  description: "Guia completa para dejar el CERN: periodos de preaviso, procedimiento de clearance, opciones de pension, seguro medico, baja administrativa y logistica de mudanza."
breadcrumbs:
...
<h1>Guia de Salida</h1>
      ...
      <div class="alert">
        ...
        <p>Comienza los preparativos de tu salida con al menos 2-3 meses de antelacion. El proceso de clearance tiene muchos pasos y algunos tienen plazos estrictos.</p>
      </div>

      <h2>Periodos de Preaviso</h2>
      <p>El periodo de preaviso que debes dar antes de dejar el CERN varia segun tu tipo de contrato. Los <strong>miembros del personal (staff)</strong> normalmente deben dar un <strong>preaviso de 3 meses</strong> antes de su fecha de salida. Los <strong>fellows</strong> generalmente trabajan hasta el final de su contrato de duracion determinada, aunque es posible una terminacion anticipada con el preaviso correspondiente. Los <strong>estudiantes</strong> finalizan igualmente su asociacion al vencimiento del contrato.</p>
      ...
      <p>Si has estado <strong>viviendo en Suiza</strong>, debes darte de baja en tu comuna (<em>signaler un d&eacute;part</em>) antes de irte. Visita tu oficina comunal con tu fecha de salida y direccion de reenvio. Si has estado <strong>viviendo en Francia</strong>, notifica a la mairie (ayuntamiento) si te registraste alli.</p>
      ...
      <ul>
        <li><a href="https://hr.cern.ch/" target="_blank" rel="noopener noreferrer">Departamento de RRHH del CERN</a></li>
